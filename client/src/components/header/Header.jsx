...
import {faHotel,faHouseUser,faBuildingColumns,faUmbrellaBeach, faPercent,faUtensils} from "@fortawesome/free-solid-svg-icons"
              ...
              Sign in/ Register
                ...
                <div className="headerSearch">
                   ...
                   <input type="text"  placeholder="Where Are You Going?" className="headerSearchInput" value={destination} onChange={e=>setDestination(e.target.value)} />
                    ...
                    <span onClick={()=>setOpenDate(!openDate)} className="headerSearchText" >Select Your Dates Here..  </span>
