...
import Resturant from "./components/resturant/Basics/Resturant"
...
function App() {
  return (
    ...
    <Routes>
      ...
      <Route path="hotels/Puri" element={<Listcity1/>}/>
      <Route path="hotels/Bhubaneswar" element={<Listcity2/>}/>
      <Route path="hotels/Balasore" element={<Listcity3/>}/>
